...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      return (this.eval__Lcalculator_Expr__sci_Map__D(x3.a$2, references) + this.eval__Lcalculator_Expr__sci_Map__D(x3.b$2, references))
      ...
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x7.name$2, references);
      var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(x7.name$2));
      expr = temp$expr;
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      if (($uI(remainingCharsCount$1.apply__O()) >= 15)) {
        return "green"
      } else if ((($uI(remainingCharsCount$1.apply__O()) >= 0) && ($uI(remainingCharsCount$1.apply__O()) <= 14))) {
        return "orange"
      } else if (($uI(remainingCharsCount$1.apply__O()) < 0)) {
        return "red"
      } else {
        throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(new $c_jl_Exception().init___T((("No color given for " + remainingCharsCount$1.apply__O()) + " remaining characters")))
      }
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
var $d_jl_Exception = new $ClassTypeData({
  jl_Exception: 0
